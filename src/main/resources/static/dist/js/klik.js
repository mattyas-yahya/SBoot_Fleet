...
// function run()
// {
// var t = document.getElementById('tablecoba');
// t.onclick = function (event) {
// event = event || window.event; //IE8
// var target = event.target || event.srcElement;
// while (target && target.nodeName !== 'H2') { // find TR
// target = target.parentElement;
// }
// var cells = target.cells; //cell collection - https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableRowElement
// if (!cells.length || target.parentNode.nodeName === 'H3') {
// return;
// }
// var f1 = document.getElementById('kembalian');
// f1.value = cells[0].innerHTML;
// $("#kembalian").val(document.getElementById('kembalian').value);
// };
// }
// })
// ();
